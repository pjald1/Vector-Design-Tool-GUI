...
public class PaintGUI extends JPanel implements Runnable, ActionListener, MouseListener, MouseMotionListener {
    ...
    public void createGUI() {
        ...
        frame.getContentPane().add(pnlOne, BorderLayout.CENTER);
        frame.getContentPane().add(pnlTwo, BorderLayout.EAST);
        //getContentPane().add(pnlThree, BorderLayout.NORTH);
        frame.getContentPane().add(pnlBtn, BorderLayout.SOUTH);
